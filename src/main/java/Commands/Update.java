...
public class Update extends Command{
    ...
    public boolean execute(String... args) {
        ...
        if (args == null || args.length != 2)
            ...
            else if (!args[1].equalsIgnoreCase("person") && isFound) {
                try {
                    ...
                    if (pers.getName() == null || pers.getPassportID() == null || pers.getHairColor() == null || pers.getLocation() == null || pers.getCoordinates() == null) {
                        ...
                        if (!updatePers.getPassportID().equals(pers.getPassportID())) updatePers.setPassport(pers.getPassportID());
                        if (!updatePers.getHairColor().equals(pers.getHairColor())) updatePers.setHair(pers.getHairColor());
                        if (!updatePers.getLocation().equals(pers.getLocation()))updatePers.setLocation(pers.getLocation());
                        if (!updatePers.getCoordinates().equals(pers.getCoordinates())) updatePers.setCoordinates(pers.getCoordinates());
